...
- The default values of the `velocity_scaling_factor` and `acceleration_scaling_factor` are now 0.1 instead of 1.0. These values can be changed in the `joint_limits.yaml` of your robot's `moveit_config` package. You can always change the values at runtime in the corresponding methods in the [move_group_interface](http://docs.ros.org/jade/api/moveit_ros_planning_interface/html/classmoveit_1_1planning__interface_1_1MoveGroup.html#a24f5ed1dad9e46d114c0c895b241ddc9) and [MoveGroupCommander](http://docs.ros.org/melodic/api/moveit_commander/html/classmoveit__commander_1_1move__group_1_1MoveGroupCommander.html#a7706effa66a0847496de477cf219a562) or the Rviz interface.
