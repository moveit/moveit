...
- Removed the example package `moveit_controller_manager_example` and instead integrated into [tutorials](https://github.com/ros-planning/moveit_tutorials/pull/304)
