...
PLUGINLIB_EXPORT_CLASS(stomp_moveit::update_filters::ControlCostProjection,
...
ControlCostProjection::ControlCostProjection() : name_("ControlCostProjectionMatrix"), num_timesteps_(0)
...
bool ControlCostProjection::initialize(moveit::core::RobotModelConstPtr robot_model_ptr, const std::string& group_name,
