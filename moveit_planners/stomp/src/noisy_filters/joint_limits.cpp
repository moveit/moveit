...
{
JointLimits::JointLimits() : lock_start_(true), lock_goal_(true)
{
...
bool JointLimits::initialize(moveit::core::RobotModelConstPtr robot_model_ptr, const std::string& group_name,
...
bool JointLimits::filter(std::size_t start_timestep, std::size_t num_timesteps, int iteration_number,
