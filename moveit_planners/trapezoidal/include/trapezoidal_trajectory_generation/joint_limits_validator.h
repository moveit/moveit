...
class JointLimitsValidator{
  public:
     ...
     */
    static bool validateAllPositionLimitsEqual(const trapezoidal::JointLimitsContainer& joint_limits);
     ...
     */
    static bool validateAllVelocityLimitsEqual(const trapezoidal::JointLimitsContainer& joint_limits);
     ...
     */
    static bool validateAllAccelerationLimitsEqual(const trapezoidal::JointLimitsContainer& joint_limits);
     ...
     * @note always returns true if has_acceleration_limits=false for all limits, or if size of joint_limits is 0 or 1
     */
    static bool validateAllDecelerationLimitsEqual(const trapezoidal::JointLimitsContainer& joint_limits);
