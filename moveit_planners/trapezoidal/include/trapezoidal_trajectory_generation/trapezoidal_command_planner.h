...
private:
  ...
  std::map<std::string, trapezoidal::PlanningContextLoaderPtr> context_loader_map_;
  ...
  trapezoidal::JointLimitsContainer aggregated_limit_active_joints_;

  /// cartesian limit
  trapezoidal::CartesianLimit cartesian_limit_;
};
