...
#include "trapezoidal_trajectory_generation/joint_limits_aggregator.h"
#include "trapezoidal_trajectory_generation/joint_limits_container.h"
#include "trapezoidal_trajectory_generation/trajectory_generator_ptp.h"
...
typedef ValueTypeContainer<trapezoidal::TrajectoryGeneratorPTP, 0> PTP_NO_GRIPPER;
typedef ValueTypeContainer<trapezoidal::TrajectoryGeneratorPTP, 1> PTP_WITH_GRIPPER;
typedef ValueTypeContainer<trapezoidal::TrajectoryGeneratorLIN, 0> LIN_NO_GRIPPER;
typedef ValueTypeContainer<trapezoidal::TrajectoryGeneratorLIN, 1> LIN_WITH_GRIPPER;
typedef ValueTypeContainer<trapezoidal::TrajectoryGeneratorCIRC, 0> CIRC_NO_GRIPPER;
typedef ValueTypeContainer<trapezoidal::TrajectoryGeneratorCIRC, 1> CIRC_WITH_GRIPPER;
...
protected:
  ...
  void SetUp() override
  {
    ...
    trapezoidal::JointLimitsContainer joint_limits =
        trapezoidal::JointLimitsAggregator::getAggregatedLimits(ros::NodeHandle(robot_description_param + "_planning"),
    ...
    trapezoidal::LimitsContainer planner_limits;
...
protected:
  ...
  std::unique_ptr<trapezoidal::TrajectoryGenerator> trajectory_generator_;
