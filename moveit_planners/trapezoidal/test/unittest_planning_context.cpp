...
#include "trapezoidal_trajectory_generation/planning_context_ptp.h"
...
typedef ValueTypeContainer<trapezoidal::PlanningContextPTP, 1> PTP_WITH_GRIPPER;
typedef ValueTypeContainer<trapezoidal::PlanningContextLIN, 0> LIN_NO_GRIPPER;
typedef ValueTypeContainer<trapezoidal::PlanningContextLIN, 1> LIN_WITH_GRIPPER;
