...
bool trapezoidal::computePoseIK(const moveit::core::RobotModelConstPtr &robot_model,
...
bool trapezoidal::computeLinkFK(const moveit::core::RobotModelConstPtr &robot_model,
                         const std::string &link_name,
...
bool trapezoidal::isRobotStateEqual(const moveit::core::RobotState &state1,
...
bool trapezoidal::isRobotStateStationary(const moveit::core::RobotState &state,
...
bool trapezoidal::linearSearchIntersectionPoint(const std::string &link_name,
...
bool trapezoidal::intersectionFound(const Eigen::Vector3d &p_center,
