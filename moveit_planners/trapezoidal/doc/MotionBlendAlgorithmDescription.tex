...
\begin{abstract}
\noindent This article describes the techniques used to blend the position and orientation of two robot trajectories within the {\tt trapezoidal\_trajectory\_generation}\cite{trapezoidaltrajectorygeneration} ROS package.
\end{abstract}
...
\bibitem{trapezoidaltrajectorygeneration}\url{https://github.com/TrapezoidalDE/trapezoidal_industrial_motion/tree/melodic-devel/trapezoidal_trajectory_generation}
\end{thebibliography}
\end{document}
