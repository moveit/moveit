...
latex_documents = [
    (master_doc, 'moveit_core.tex', 'moveit\\_core Documentation',
     'peter', 'manual'),
]
...
man_pages = [
    (master_doc, 'moveit_core', 'moveit_core Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'moveit_core', 'moveit_core Documentation',
     author, 'moveit_core', 'One line description of project.',
     'Miscellaneous'),
]
